...
from utils.dataloader_cachedataloader_single import DatasetGEN3D_CacheDataloader
...
class Trainer(object):
    def __init__(self, k=0,
                 ...
                 train_dir='/home/yweibs/scratch/yweibs/data/',
                 result_dir='results',
                 model_name='RaSD'
                 ):
        ...
        self.train_dataset = DatasetGEN3D_CacheDataloader(train_dir, batchsize=batch_size)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Offline pretraining using cached NIfTI data')
    ...
    parser.add_argument('--train_dir', type=str, default='/home/yweibs/scratch/yweibs/data/')
