...
parser.add_argument("--name", default='LVM_R50', help="the name of pre-trained model !!!!!!!!")
parser.add_argument("--feature_size", default=48, type=int, help="feature size")
parser.add_argument("--pretrained_root", default='/home/yweibs/weights', help="pre-trained root")

parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/LVM_R50/", type=str, help="directory to save the tensorboard logs")

parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/DRIVE/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/project/smartlab2021/yweibs/DRIVE/cache", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./DRIVE.json", type=str, help="dataset json file")
