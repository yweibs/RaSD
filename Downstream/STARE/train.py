...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/STARE/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/project/smartlab2021/yweibs/STARE/cache", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./STARE.json", type=str, help="dataset json file")
