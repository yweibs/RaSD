...
parser.add_argument("--pretrained_path", default='RaSE_B.pth', help="pre-trained root")
...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/CC-CCII/data", type=str, help="dataset directory")
