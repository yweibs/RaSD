...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/MSD07/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./dataset_panc.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/MSD07/cache', type=str, help="dataset json file")
