...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/CHAOS", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./chaos.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/CHAOS/cache', type=str, help="dataset json file")
...
parser.add_argument("--space_z", default=5.5, type=float, help="spacing in z direction")
