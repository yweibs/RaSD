...
parser.add_argument('--model_path', type=str, default='/jhcnas1/wulinshan/checkpoints/luna_ncc/unet_3d_dense_Simple_luna_ncc_rcb_(order_xyz)/20230718-111855/model_best.pth')
