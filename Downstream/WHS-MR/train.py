...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/MMWHS/mr_train", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/project/smartlab2021/yweibs/MMWHS/mr_train/cache", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./MM-WHS-MRI.json", type=str, help="dataset json file")
