...
parser.add_argument("--data_dir", default="/scratch/yweibs/ATLAS", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/scratch/yweibs/ATLAS/cache", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./ATLAS-MRI.json", type=str, help="dataset json file")
