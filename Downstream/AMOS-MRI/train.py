...
# parser.add_argument("--checkpoint", default="/project/smartlab2021/yweibs/weights/amos/model_swssl.pt", help="start training from saved checkpoint")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/swinunetr", type=str, help="directory to save the tensorboard logs")

parser.add_argument("--data_dir", default="/scratch/yweibs/AMOS", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/scratch/yweibs/AMOS/cache", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./AMOS_MRI.json", type=str, help="dataset json file")
