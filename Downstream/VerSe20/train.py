...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/VerSe/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/VerSe/cache', type=str, help="dataset json file")
parser.add_argument("--json_list", default="./VerSe.json", type=str, help="dataset json file")
...
parser.add_argument("--out_channels", default=29, type=int, help="number of output channels")
