...
parser.add_argument("--name", default='suprem', help="the name of pre-trained model !!!!!!!!")

parser.add_argument("--feature_size", default=48, type=int, help="feature size")
parser.add_argument("--pretrained_root", default='/home/yweibs/weights', help="pre-trained root")

parser.add_argument("--checkpoint", default="logs/suprem/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/suprem", type=str, help="directory to save the tensorboard logs")
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/BTCV/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/BTCV/cache', type=str, help="dataset directory")
parser.add_argument("--json_list", default="/home/yweibs/Done/BTCV/dataset/dataset_1.json", type=str, help="dataset json file")
...
parser.add_argument("--test_mode", default=False, help="use test mode")
