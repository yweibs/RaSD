...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/MMWHS/ct_train", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/MMWHS/ct_train/cache', type=str, help="dataset directory")
