...
parser = argparse.ArgumentParser(description="IDRiD")
parser.add_argument("--modality", default='Fundus', help="the fundus of the dataset !!!!!!!!")
parser.add_argument("--name", default='Scratch', help="the name of pre-trained model !!!!!!!!")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/scratch/", type=str, help="directory to save the tensorboard logs")
...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/DRAC/Grading/Images/Train", type=str, help="dataset directory")
