...
parser.add_argument("--data_dir", default="/home/yweibs/scratch/yweibs/BraTS", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/home/yweibs/scratch/yweibs/BraTS/cache", type=str, help="dataset directory")
