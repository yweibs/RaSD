...
parser.add_argument("--checkpoint", default="/home/yweibs/project/weights/COVID/model_voco.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/voco", type=str, help="directory to save the tensorboard logs")

parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/Covid/Train", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/Covid/cache', type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Covid19_20_folds.json", type=str, help="dataset json file")
...
parser.add_argument("--sw_batch_size", default=3, type=int, help="number of sliding window batch size")
