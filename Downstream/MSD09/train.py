...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/MSD09/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./spleen.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/MSD09/cache', type=str, help="dataset json file")
