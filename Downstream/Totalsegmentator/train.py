...
parser.add_argument("--name", default='RaSE_B', help="the name of pre-trained model !!!!!!!!")
parser.add_argument("--feature_size", default=48, type=int, help="feature size")
parser.add_argument("--pretrained_root", default='/home/yweibs/weights', help="pre-trained root")


parser.add_argument("--checkpoint", default="logs/RaSE_B/model_final.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/RaSE_B/", type=str, help="directory to save the tensorboard logs")
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/Totalsegmentator/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Totalsegmentator.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/Totalsegmentator/cache', type=str, help="dataset json file")
...
parser.add_argument("--val_every", default=200, type=int, help="validation frequency")
...
parser.add_argument("--out_channels", default=105, type=int, help="number of output channels")
...
def main_worker(gpu, args):
    ...
    if args.optim_name == "adam":
        ...
        optimizer = torch.optim.SGD(
            model.parameters(), lr=1e-2, momentum=args.momentum, nesterov=True, weight_decay=args.reg_weight
        )
    else:
