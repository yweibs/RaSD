...
parser.add_argument("--checkpoint", default="logs/voco/model_vo.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/voco", type=str, help="directory to save the tensorboard logs")

parser.add_argument("--data_dir", default="/scratch/yweibs/ACDC", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/scratch/yweibs/ACDC/cache", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./ACDC.json", type=str, help="dataset json file")
