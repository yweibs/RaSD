...
parser.add_argument("--name", default='swin', help="the name of pre-trained model !!!!!!!!")
parser.add_argument("--feature_size", default=48, type=int, help="feature size")
parser.add_argument("--pretrained_root", default='/home/yweibs/weights', help="pre-trained root")

# parser.add_argument("--checkpoint", default="/project/smartlab2021/yweibs/weights/BHSD/model_scratch.pt", help="start training from saved checkpoint")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/swin", type=str, help="directory to save the tensorboard logs")

parser.add_argument("--data_dir", default="/scratch/yweibs/BHSD", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./BHSD.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/scratch/yweibs/BHSD/cache', type=str, help="dataset json file")
...
parser.add_argument("--out_channels", default=6, type=int, help="number of output channels")

parser.add_argument("--a_min", default=0.0, type=float, help="a_min in ScaleIntensityRanged")
parser.add_argument("--a_max", default=100.0, type=float, help="a_max in ScaleIntensityRanged")
