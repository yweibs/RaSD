...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/ircadb", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./3D-IRCADb.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/ircadb/cache', type=str, help="dataset json file")
