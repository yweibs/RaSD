...
parser.add_argument("--checkpoint", default="/home/yweibs/project/weights/parse/model_voco.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs/voco", type=str, help="directory to save the tensorboard logs")
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/Parse22/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Parse22.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/Parse22/cache', type=str, help="dataset json file")
