...
parser.add_argument("--data_dir", default="/project/smartlab2021/yweibs/Segthor/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/project/smartlab2021/yweibs/Segthor/cache', type=str, help="dataset json file")
